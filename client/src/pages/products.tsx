...
const products: Product[] = [
  {
    ...
    name: "Starfish Slack",
    description:
      "A Slack-based AI assistant that answers questions from uploaded documents directly inside Slack.",
  ...
  },
  {
    ...
    description:
      "AI assistant for WhatsApp that instantly answers questions from your uploaded documents in your chat.",
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-12">
            Powerful data solutions designed to transform your business. From
            analytics to intelligence, we provide comprehensive tools to help
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-muted/50">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-muted-foreground mb-8">
            Join thousands of businesses already using our products to make
